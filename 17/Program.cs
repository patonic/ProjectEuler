...
namespace _17
{
    class Program
    {
        ...
        static void calculating()
        {
            ...
            {
                sum += Convert.ToUInt64(NumberToWords.Convert(i).Replace(" ", string.Empty).Replace("-", string.Empty).Length);
            }
    ...
    }   //Не мой класс https://www.c-sharpcorner.com/blogs/convert-number-to-words-in-c-sharp
}
